...
Simple and clean implementation of a Generative AI text generator

Easy-to-run Jupyter Notebook (.ipynb)
...
The model generates output based on your prompt
...
Add a proper GenAI model with API (OpenAI, HuggingFace, Groq, etc.)
